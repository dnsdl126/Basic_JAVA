...
public class ProductDAO {
	...
	public void insertPdt(String company, String pname, int price, int cnt) {
	...
	public void pdtSearch (String pname) {
		sqlSession= sqlSessionFactory.openSession();
		
		
		try {
			list = sqlSession.selectList("pdtSearch",pname); // 아무것도 없는 기본 생성자 필요
			if (list.size() > 0) {
			System.out.println("■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■");
